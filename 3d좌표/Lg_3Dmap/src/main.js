...
let A_TotalFloor = 13 //13
let B_TotalFloor = 9 //9
// 층 간격
let gap = 300
...
draw();
    ...
    function modelstair(x0, y0, x1, y1, z0, height0, stairHeight, staitDepth, angle) {
        ...
        for (let i = 0; i <= (((y1-y0) / staitDepth)-1); i += 2) {
            ...
            stairBox.position.x = Math.round(x0*9.97)*0.2+800;
    ...
    modelstair(200, 430, 100, 890, 230,  300, 15, 20, 0);
    ...
    modelstair1(200, 430, 100, 890, 230,  300, 15, 20, 0);
/* 외부명령 *
/* 안드로이드 브릿지 */
